...
<!-- Mirrored from www.indonez.com/html-demo/Profit/homepage4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Feb 2023 18:05:49 GMT -->
<!-- Added by HTTrack -->
...
<body>
          ...
          <div class="uk-width-1-1">
            <div data-uk-slider="autoplay: true; autoplay-interval: 5000">
              <ul class="uk-grid-large uk-slider-items uk-child-width-1-3@s uk-child-width-1-6@m uk-text-center"
                data-uk-grid>
                <li>
                  <i class="fas fa-angle-up in-icon-wrap small circle up"></i>
                  XAUUSD <span class="uk-text-success">1478.81</span>
                </li>
                <li>
                  <i class="fas fa-angle-down in-icon-wrap small circle down"></i>
          ...
          <div class="uk-navbar-left uk-width-auto">
            <div class="uk-navbar-item">
              ...
              <a class="uk-logo" href="index.html">
                <img class="in-offset-top-10" src="/asset/img/in-lazy.svg" data-src="/asset/img/in-logo-1.svg" alt="logo" width="130"
  ...
  <main>
              ...
              <div class="uk-grid" data-uk-grid>
                <div class="uk-width-1-2@m">
                  <div class="uk-overlay">
                    <h1>
                      Multi-award
                      <span class="in-highlight">winning</span> forex
                      provider.
                    </h1>
                    <p class="uk-text-lead uk-visible@m">
                      We have been proud to offer traders a powerful and
                ...
                <div class="uk-position-center">
                  <img src="/asset/img/image 2.png" width="862" height="540" alt="" />
                </div>
              </div>
            </div>
          </li>
            ...
            <div class="uk-container">
              <div class="uk-grid" data-uk-grid>
                <div class="uk-width-1-2@m">
                  <div class="uk-overlay">
                    <h1>
                      Get more <span class="in-highlight">freedom</span> in
                      the markets.
                    </h1>
                    <p class="uk-text-lead uk-visible@m">
                ...
                <div class="uk-position-center">
                  <img src="/asset/img/image 1.png" width="862" height="540" alt="" />
                </div>
              </div>
            </div>
          </li>
        ...
        <div class="uk-child-width-1-2@s uk-child-width-1-2@m uk-margin-medium-top uk-margin-bottom" data-uk-grid>
          <div>
            <div class="in-pricing-1">
              <div class="uk-card uk-card-default">
                ...
                <div class="uk-card-body uk-background-contain uk-background-bottom-right"
                  data-src="/asset/img/in-section-profit-13a.png" data-uk-img>
                  ...
                  <a href="#" class="uk-button uk-button-secondary uk-border-rounded uk-margin-small-top">Open an
                    account</a>
                </div>
              </div>
            </div>
          ...
          <div>
            <div class="in-pricing-1">
              <div class="uk-card uk-card-default">
                <div class="uk-card-header">
                  <h3 class="uk-margin-remove-bottom">Platinum account</h3>
                  <p class="uk-text-muted uk-margin-remove-top">
                    Receive even tighter spreads and commissions
                  </p>
                </div>
                <div class="uk-card-body uk-background-contain uk-background-bottom-right"
                  data-src="/asset/img/in-section-profit-13b.png" data-uk-img>
                  <ul class="uk-list uk-list-bullet uk-margin-bottom">
    ...
    <!-- section content begin -->
    <div
      class="uk-section uk-padding-large uk-background-contain uk-background-bottom-center in-padding-large-vertical@s in-offset-top-40 in-profit-14"
      data-src="/asset/img/in-section-profit-14.jpg" data-uk-img>
      <div class="uk-container uk-margin-bottom">
        <div class="uk-child-width-1-2@s uk-child-width-1-4@m uk-text-center" data-uk-grid>
          <div class="uk-width-1-1">
            <h2>What can you trade with Profit Inc?</h2>
          </div>
          <div>
            <img src="/asset/img/in-lazy.svg" data-src="/asset/img/in-profit-icon-7.svg" alt="profit-icon" width="86" height="86"
              data-uk-img />
            <h4 class="uk-heading-bullet uk-margin-top">Forex</h4>
            <p>
              Quis autem eum iure reprehenderit humea voluptate velit esse.
            </p>
            <a class="uk-text-uppercase uk-text-small" href="#">View full list<i
                class="fas fa-caret-square-right uk-margin-small-left"></i></a>
          </div>
          <div>
            <img src="/asset/img/in-lazy.svg" data-src="/asset/img/in-profit-icon-8.svg" alt="profit-icon" width="86" height="86"
              data-uk-img />
          ...
          <div>
            <img src="/asset/img/in-lazy.svg" data-src="/asset/img/in-profit-icon-9.svg" alt="profit-icon" width="86" height="86"
              data-uk-img />
          ...
          <div>
            <img src="/asset/img/in-lazy.svg" data-src="/asset/img/in-profit-icon-10.svg" alt="profit-icon" width="86" height="86"
              data-uk-img />
      ...
      <div class="uk-container">
        <div class="uk-grid uk-flex uk-flex-center" data-uk-grid>
          <div class="uk-width-1-1 uk-width-5-6@m">
            ...
            <h2 class="uk-margin-small-top uk-text-center">
      ...
      <div class="uk-container uk-margin-small-bottom">
        <div class="uk-grid-divider" data-uk-grid>
          ...
          <div class="uk-width-expand@m">
            <div class="uk-grid-medium uk-child-width-1-2 uk-child-width-1-5@m uk-text-center in-client-logo-3"
              data-uk-grid>
              <div class="uk-tile uk-tile-default">
                <img src="/asset/img/in-lazy.svg" data-src="/asset/img/in-profit-payment-1.svg" alt="payment-logo" width="172"
                  height="57" data-uk-img />
              </div>
              <div class="uk-tile uk-tile-default">
                <img src="/asset/img/in-lazy.svg" data-src="/asset/img/in-profit-payment-2.svg" alt="payment-logo" width="172"
                  height="57" data-uk-img />
              </div>
              <div class="uk-tile uk-tile-default">
                <img src="/asset/img/in-lazy.svg" data-src="/asset/img/in-profit-payment-3.svg" alt="payment-logo" width="172"
                  height="57" data-uk-img />
              </div>
              <div class="uk-tile uk-tile-default">
                <img src="/asset/img/in-lazy.svg" data-src="/asset/img/in-profit-payment-4.svg" alt="payment-logo" width="172"
                  height="57" data-uk-img />
              </div>
              <div class="uk-tile uk-tile-default uk-visible@m">
                <img src="/asset/img/in-lazy.svg" data-src="/asset/img/in-profit-payment-5.svg" alt="payment-logo" width="172"
                  height="57" data-uk-img />
              </div>
            </div>
          </div>
        ...
        <div class="uk-grid uk-flex uk-flex-center" data-uk-grid>
          <div class="uk-width-3-4@m">
            <div class="in-create-account uk-text-center uk-margin-top">
              <span class="uk-label uk-text-small uk-text-uppercase uk-border-rounded uk-margin-small-bottom">Open your
                account</span>
    ...
    <!-- section content begin -->
    <div
      class="uk-section uk-padding-large uk-background-contain in-padding-large-vertical@s in-offset-bottom-80 in-profit-17"
      data-src="/asset/img/in-profit-decor-3.svg" data-uk-img>
      <div class="uk-container">
        <div class="uk-grid uk-flex uk-flex-center" data-uk-grid>
          <div class="uk-width-5-6@m">
            <div class="uk-grid uk-child-width-1-2@m uk-flex" data-uk-grid>
              <div class="in-offset-bottom-30 uk-flex-last uk-flex-first@m">
                <img src="/asset/img/in-lazy.svg" data-src="/asset/img/in-profit-mockup-3.png" alt="profit-mockup" width="472"
                  height="348" data-uk-img />
              </div>
              <div>
                <h2>Platform by traders,<br />for traders</h2>
      ...
      <div class="uk-container">
        <div class="uk-child-width-1-2@s uk-child-width-1-5@m uk-flex" data-uk-grid>
          ...
          <div class="uk-flex-first uk-flex-last@m">
            <ul class="uk-list uk-link-text">
              <li>
                <img class="uk-margin-small-bottom" src="/asset/img/in-lazy.svg" data-src="/asset/img/in-logo-2.svg" alt="logo"
                  width="130" height="36" data-uk-img />
              </li>
              <li>
                <a href="#"><i class="fas fa-envelope uk-margin-small-right"></i>info@profit.id</a>
              </li>
              <li>
                <a href="#"><i class="fas fa-map-marker-alt uk-margin-small-right"></i>Jakarta, Indonesia</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="uk-grid uk-flex uk-flex-center uk-margin-large-top" data-uk-grid>
          <div class="uk-width-5-6@m uk-margin-bottom">
            <div class="in-footer-warning in-margin-top-20@s">
              <h5 class="uk-text-small uk-text-uppercase">
          ...
          <div class="uk-width-1-2@m in-copyright-text">
            <p>© Profit Inc 2020. All rights reserved.</p>
          </div>
...
<!-- Mirrored from www.indonez.com/html-demo/Profit/homepage4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Feb 2023 18:06:02 GMT -->
